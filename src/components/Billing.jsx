  ...
  return (
    <section id="product" className={layout.sectionReverse}>
      <div className={layout.sectionImgReverse}>
        ...
        <div className='absolute z-[3] -left-[100%] top-0 w-1/2 h-1/2 rounded-full white__gradient'></div>
        <div className='absolute z-[0] -left-[100%] bottom-0 w-1/2 h-1/2 rounded-full pink__gradient'></div>
      </div>
      <div className={layout.sectionInfo}>
        ...
        <div className=" flex flex-row flex-wrap sm:mt-10 mt-6">
          <img src={apple} alt="play store" className="w-[128px] h-[42px] object-contain mr-5 cursor-pointer" />
